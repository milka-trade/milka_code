                    ...
                    if cur_price < day_open_price_1*1.02:                                    
                        ...
                        if last_ta_rsi < 60 :
                            ...
                            if df_15_low1 < Low_Bol or df_15_low2 < Low_Bol :
                                ...
                                # print(f"[test 6]: [{t}] 0 < [last s_RSI]:{last_ta_srsi:,.2f} <= 0.2")
                                if 0 < last_ta_srsi <= 0.15:
                                    print(f"[cond 6]: [{t}] 0 < [last s_RSI]:{last_ta_srsi:,.2f} <= 0.15")
                                    send_discord_message(f"[cond 6]: [{t}] 0 < [last s_RSI]:{last_ta_srsi:,.2f} <= 0.15")
