        ...
        try:
            ...
            if threshold_value < atr :
                ...
                if cur_price < day_open_price_1*1.03:                                    
                    ...
                    if 0 < previous_ta_srsi < last_ta_srsi <= 0.15:
                                print(f"[cond 4]: [{t}] 0 < [pre s_RSI]: {previous_ta_srsi:,.2f} < [last s_RSI]:{last_ta_srsi:,.2f} <= 0.15")   
                                ...
                                if last_ta_rsi < 60 :
                                    ...
                                    if df_15_low1 < Low_Bol*1.005 or df_15_low2 < Low_Bol*1.005 or cur_price < Low_Bol*0.99:
